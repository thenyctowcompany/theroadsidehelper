...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    title: "House & Apartment Lockout",
    subtitle: "Locked Out of Your Home",
    description: "Locked out of your house or apartment? Our locksmith techs can pick most standard residential locks without damage or replacement.",
    longDescription: "Residential lockout is a sister service to car lockouts. We can pick most pin-tumbler, deadbolt, and lever locks without damaging the door, frame, or hardware. If the lock is high-security (Medeco, ASSA, or similar), it may require a drill-and-replace approach, which we'll quote before doing anything destructive. We require ID confirming you live at or have legal access to the address — utility bill, driver's license matching, or landlord on the phone — before we open any residential door.",
    ideal: ["Homeowners", "Renters", "Anyone locked out of their home"],
    category: "lockout",
  },
  {
...
export const SERVICE_CATEGORIES = {
  ...
  lockout: { label: "Lockout Service", description: "Car, home, and key fob lockout assistance" },
